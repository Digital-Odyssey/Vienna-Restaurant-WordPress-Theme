        ...
        <?php } ?>
            ...
            <ul class="pm-meta-options-list">
            	...
            	<?php 
					if(is_sticky()){
						?>
                        <li><i class="fa fa-thumb-tack" style="padding-left:2px;"></i> &nbsp;&nbsp;<?php esc_html_e('Featured Post','viennatheme'); ?></li>
                        <?php
					}
				?>
            
                <li><i class="fa fa-comment"></i> &nbsp;<?php  echo get_comments_number();  ?> <?php esc_html_e('Comments','viennatheme'); ?></li>
                <li><i class="fa fa-twitter"></i> &nbsp;<a href="https://twitter.com/share?url=<?php urlencode(the_permalink()); ?>&text=<?php urlencode(the_title()); ?>" target="_blank"><?php esc_html_e('Tweet this','viennatheme'); ?></a></li>
