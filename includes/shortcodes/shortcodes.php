	...
	$html .= '<form action="#" method="post" id="pm-reservation-form">';
		...
		$html .= '<div class="row">';
			...
			$html .= '<div class="col-lg-4 col-md-4 col-sm-12">';
				...
				$html .= '<input name="pm-first-name-field" class="pm-textfield" type="text" placeholder="'. esc_html__('First name','viennatheme') .' *" id="reservation-form-first-name">';
				
				$html .= '<input name="pm-last-name-field" class="pm-textfield" type="text" placeholder="'. esc_html__('Last name','viennatheme') .' *" id="reservation-form-last-name">';
				
				$html .= '<input name="pm-email-field" class="pm-textfield" type="text" placeholder="'. esc_html__('Email address','viennatheme') .' *" id="reservation-form-email-address">';
			
			$html .= '</div>';
			
			$html .= '<div class="col-lg-4 col-md-4 col-sm-12">';
			
				$html .= '<input name="pm-phone-field" class="pm-textfield" type="text" placeholder="'. esc_html__('Phone Number *','viennatheme') .'" id="reservation-phone">';                   
				
				$html .= '<input name="pm-date-of-reservation-field" class="pm-textfield reservation-form-datepicker" type="text" placeholder="'. esc_html__('Date of Reservation','viennatheme') .' *" id="datepicker">';
				
				$html .= '<input name="pm-num-of-seats-field" class="pm-textfield" type="text" placeholder="'. esc_html__('Number of seats','viennatheme') .' *" id="reservation-form-num-of-seats-field">';
			
			$html .= '</div>';
			
			$html .= '<div class="col-lg-4 col-md-4 col-sm-12">';
				
				$html .= '<input name="pm-restaurant-location-field" class="pm-textfield" type="text" placeholder="'. esc_html__('Restaurant Location','viennatheme') .' *" id="reservation-form-location-field">';
				
				$html .= '<input name="pm-time-of-reservation-field" class="pm-textfield" type="text" placeholder="'. esc_html__('Time of Reservation (ex. 7:00pm - 9:00pm)','viennatheme') .' *" id="reservation-form-time-field">';	
		...
		$html .= '<div class="row">';
			...
			$html .= '<div class="col-lg-12">';
				$html .= '<textarea name="pm-additional-info-field" id="pm-additional-info-field" cols="20" rows="10" placeholder="'. esc_html__('Additional Information','viennatheme') .'" class="pm-form-textarea"></textarea>';
			$html .= '</div>';
		...
		$html .= '<p class="pm-form-security-question">'. esc_attr__('Security question', 'viennatheme') .': </p>';
			
		$html .= '<ul class="pm-form-security-question-list">';
		
			$html .= '<li><strong>'. esc_attr($randNum1) .'</strong> + <strong>'.  esc_attr($randNum2) .'</strong> =</li>';
			$html .= '<li><input type="text" maxlength="2" class="pm-form-textfield security-field property-post" name="pm_contact_form_security_question" id="pm_contact_form_security_question" /></li>';
		
		$html .= '</ul>';
	
		$html .= '<input type="hidden" value="'. (esc_attr($randNum1) + esc_attr($randNum2)) .'" id="pm_contact_form_security_answer" name="pm_contact_form_security_answer">';
		...
		$html .= '<div class="row">';
			$html .= '<div class="col-lg-12">';
				...
				if( $display_terms_checkbox === 'yes' ){
					$html .= '<p class="pm-terms-checkbox"><input type="checkbox" id="pm_terms_checkbox"> '. esc_html__('I agree to the Terms and Conditions','viennatheme') .'</p>';	
				}
				
				$html .= '<div id="pm-reservation-form-response"></div>';
			
				$html .= '<input type="submit" class="pm-rounded-submit-btn" value="'. esc_html__('Send Request','viennatheme') .'" id="pm-reservation-form-btn" />';
...
function eventForm($atts, $content = null) {
	...
	$html .= '<form action="#" method="post" id="pm-event-form">';
		$html .= '<div class="row">';
			$html .= '<div class="col-lg-4 col-md-4 col-sm-12">';
				$html .= '<input name="pm-first-name-field" class="pm-textfield" type="text" placeholder="'. esc_html__('First name','viennatheme') .' *" id="event-form-first-name">';
				$html .= '<input name="pm-last-name-field" class="pm-textfield" type="text" placeholder="'. esc_html__('Last name','viennatheme') .' *" id="event-form-last-name">';
				$html .= '<input name="pm-email-field" class="pm-textfield" type="text" placeholder="'. esc_html__('Email address','viennatheme') .' *" id="event-form-email-address">';
			$html .= '</div>';
			
			$html .= '<div class="col-lg-4 col-md-4 col-sm-12">';
				$html .= '<input name="pm-phone-field" id="event-form-phone-number" class="pm-textfield" type="text" placeholder="'. esc_html__('Phone Number','viennatheme') .'">';
				$html .= '<select name="pm-event-inquiry-field" id="event-form-event-type">';
					$html .= '<option value="">'. esc_html__('-- Event Type --','viennatheme') .'</option>';
					$html .= '<option value="'. esc_html__('Corporate Party','viennatheme') .'">'. esc_html__('Corporate Party','viennatheme') .'</option>';
					$html .= '<option value="'. esc_html__('School Function','viennatheme') .'">'. esc_html__('School Function','viennatheme') .'</option>';
					$html .= '<option value="'. esc_html__('Engagement','viennatheme') .'">'. esc_html__('Engagement','viennatheme') .'</option>';
					$html .= '<option value="'. esc_html__('Baby Shower','viennatheme') .'">'. esc_html__('Baby Shower','viennatheme') .'</option>';
					$html .= '<option value="'. esc_html__('Birthday Party','viennatheme') .'">'. esc_html__('Birthday Party','viennatheme') .'</option>';
					$html .= '<option value="'. esc_html__('Social Gathering','viennatheme') .'">'. esc_html__('Social Gathering','viennatheme') .'</option>';
					$html .= '<option value="'. esc_html__('Wedding','viennatheme') .'">'. esc_html__('Wedding','viennatheme') .'</option>';
					$html .= '<option value="'. esc_html__('Other','viennatheme') .'">'. esc_html__('Other','viennatheme') .'</option>';
				$html .= '</select>';
				$html .= '<input name="pm-date-of-event-field" class="pm-textfield event-form-datepicker" type="text" placeholder="'. esc_html__('Date of Event','viennatheme') .' *" id="datepicker">';
			$html .= '</div>';
			
			$html .= '<div class="col-lg-4 col-md-4 col-sm-12">';
				$html .= '<input name="pm-num-of-guests-field" class="pm-textfield" type="text" placeholder="'. esc_html__('Number of Guests','viennatheme') .' *" id="event-form-guests-field">';
				$html .= '<input name="pm-time-of-event-field" class="pm-textfield" type="text" placeholder="'. esc_html__('Time of Event (ex. 7:00pm - 9:00pm)','viennatheme') .' *" id="event-form-time-field">	';
			$html .= '</div>';
		...
		$html .= '<div class="row">';
			$html .= '<div class="col-lg-12">';
				...
				$html .= '<input type="submit" class="pm-rounded-submit-btn" value="'. esc_html__('Send Request','viennatheme') .'" id="pm-event-form-btn" />';
			$html .= '</div>';
		$html .= '</div>';
...
function cateringForm($atts, $content = null) {
	...
	$html .= '<form action="#" method="post" id="pm-catering-form">';
		...
		$html .= '<div class="row">';
			...
			$html .= '<div class="col-lg-4 col-md-4 col-sm-12">';
				$html .= '<input name="pm-first-name-field" class="pm-textfield" type="text" placeholder="'. esc_html__('First name','viennatheme') .' *" id="catering-form-first-name" required>';
				$html .= '<input name="pm-last-name-field" class="pm-textfield" type="text" placeholder="'. esc_html__('Last name','viennatheme') .' *" id="catering-form-last-name" required>';
				$html .= '<input name="pm-email-field" class="pm-textfield" type="text" placeholder="'. esc_html__('Email address','viennatheme') .' *" id="catering-form-email-address" required>';
			$html .= '</div>';
			
			$html .= '<div class="col-lg-4 col-md-4 col-sm-12">';
				$html .= '<input name="pm-phone-field" class="pm-textfield" id="catering-form-phone-number" type="text" placeholder="'. esc_html__('Phone Number','viennatheme') .'">';	
				$html .= '<select name="pm-event-inquiry-field" id="catering-form-event-type" required>';
					$html .= '<option value="">'. esc_html__('-- Event Type --','viennatheme') .' </option>';
					$html .= '<option value="'. esc_html__('Wedding','viennatheme') .'">'. esc_html__('Wedding','viennatheme') .'</option>';
					$html .= '<option value="'. esc_html__('Corporate','viennatheme') .'">'. esc_html__('Corporate','viennatheme') .'</option>';
					$html .= '<option value="'. esc_html__('School Function','viennatheme') .'">'. esc_html__('School Function','viennatheme') .'</option>';
					$html .= '<option value="'. esc_html__('Banquet','viennatheme') .'">'. esc_html__('Banquet','viennatheme') .'</option>';
					$html .= '<option value="'. esc_html__('Stag','viennatheme') .'">'. esc_html__('Stag','viennatheme') .'</option>';
					$html .= '<option value="'. esc_html__('Engagement','viennatheme') .'">'. esc_html__('Engagement','viennatheme') .'</option>';
					$html .= '<option value="'. esc_html__('Backyard party','viennatheme') .'">'. esc_html__('Backyard party','viennatheme') .'</option>';
					$html .= '<option value="'. esc_html__('Other','viennatheme') .'">'. esc_html__('Other','viennatheme') .'</option>';
				$html .= '</select>';
				$html .= '<input name="pm-date-of-event-field" class="pm-textfield catering-form-datepicker" type="text" placeholder="'. esc_html__('Date of Event','viennatheme') .' *" id="datepicker">';
			$html .= '</div>';
			
			$html .= '<div class="col-lg-4 col-md-4 col-sm-12">';
				$html .= '<input name="pm-num-of-guests-field" class="pm-textfield" type="text" placeholder="'. esc_html__('Number of Guests','viennatheme') .' *" id="catering-form-guests-field" required>';
				$html .= '<input name="pm-event-location-field" class="pm-textfield" type="text" placeholder="'. esc_html__('Event Location','viennatheme') .' *" id="catering-form-location-field" required>';	
				$html .= '<input name="pm-time-of-event-field" class="pm-textfield" type="text" placeholder="'. esc_html__('Time of Event (ex. 7:00pm - 9:00pm)','viennatheme') .' *" id="catering-form-time-field" required>';	
			$html .= '</div>';
		...
		$html .= '<div class="row">';
			$html .= '<div class="col-lg-12">';
				...
				$html .= '<input type="submit" class="pm-rounded-submit-btn pm-clear-both" value="'. esc_html__('Send Request','viennatheme') .'" id="pm-catering-form-btn" />';
...
function postItems($atts, $content = null) {
	...
	$html .= '<div class="row">';
		...
		$html .= '<div'. ($num_of_posts > 3 ? ' id="pm-postItems-carousel"' : '') .'>';
					...
					$html .= '<div class="pm-news-post-container">';
						...
						$html .= '<div class="pm-news-post-meta-container">';
							...
							$html .= '<ul class="pm-meta-options-list">';
								$html .= '<li><i class="fa fa-comment"></i> &nbsp;'.get_comments_number().' '.esc_html__('Comments','viennatheme').'</li>';
								$html .= '<li><i class="fa fa-twitter"></i> &nbsp;<a href="https://twitter.com/share?url='. urlencode(get_the_permalink()) .'&amp;text='. urlencode(get_the_title()) .'" target="_blank">'.esc_html__('Tweet this','viennatheme').'</a></li>';
								$html .= '<li><i class="fa fa-pencil"></i> &nbsp;<a href="'.get_comments_link().'">'.esc_html__('Post a comment','viennatheme').'</a></li>';
							$html .= '</ul>';
						$html .= '</div>';
						$html .= '<div class="pm-news-post-desc-container">';
							...
							$html .= '<p class="pm-news-post-continue"><a href="'.get_the_permalink().'">'.esc_html__('Continue Reading','viennatheme').' &rarr;</a></p>';
						$html .= '</div>';
					$html .= '</div>';
				$html .= '</div>';
			...
			endwhile; else:
				$html .= '<div class="col-lg-12 pm-column-spacing">';
				 $html .= '<p>'.esc_html__('No posts were found.', 'viennatheme').'</p>';
				$html .= '</div>';
			endif;
...
function eventItems($atts, $content = null) {
	...
	$html .= '<div class="row">';
		...
		$html .= '<div'. ($num_of_posts > 3 ? ' id="pm-eventItems-carousel"' : '') .'>';
					...
					$html .= '<div class="pm-event-item-container">';
						...
						$html .= '<div class="pm-event-item-desc">';
							...
							if($pm_event_start_time_meta !== '' && $pm_event_end_time_meta !== '') :
                                ...
                                $html .= '<p class="pm-event-item-times"><strong class="pm-primary">'. esc_html__('START:', 'viennatheme') .'</strong> '. esc_attr($pm_event_start_time_meta) .' <strong class="pm-primary">'. esc_html__('END:', 'viennatheme') .'</strong> '. esc_attr($pm_event_end_time_meta) .'</p>';
							...
							$html .= '<ul class="pm-event-item-btns">';
								$html .= '<li><a href="'. get_the_permalink() .'" class="pm-rounded-btn small">'. esc_html__('More Info','viennatheme') .'</a></li>';
								if($pm_event_fan_page_meta !== '') {
									$html .= '<li><a href="'. $pm_event_fan_page_meta .'" class="pm-rounded-btn small event-fan-page" target="_blank"><i class="fa fa-facebook"></i> &nbsp;'. esc_html__('Fan Page','viennatheme') .'</a></li>';
								} 
							$html .= '</ul>';
						$html .= '</div>';
					$html .= '</div>';
			...
			endwhile; else:
				 $html .= '<div class="col-lg-12"><p>'.esc_html__('No events were found.', 'viennatheme').'</p></div>';
			endif;
...
function menuItems($atts, $content = null) {
	...
	$html .= '<div class="row">';
                ...
                $html .= '<div class="pm-isotope-filter-container shortcode">';
                    $html .= '<ul class="pm-isotope-filter-system">';
						if($tag !== '') {
							...
							$category_formatted = str_replace("-", " ", $category);
							$html .= '<li><a class="current">'.$category_formatted.'</a></li>';			
						}										
                    $html .= '</ul>';
                $html .= '</div>';			
			endif;			
		...
		$html .= '<div'. ($num_of_posts > 3 && $enable_carousel === 'on' ? ' class="pm-menuItems-carousel"' : '') .'>';
						...
						$html .= '<div class="col-lg-4 col-md-4 col-sm-12 pm-column-spacing">';	
							...
							$html .= '<div class="pm-menu-item-container">';
								...
								$html .= '<div class="pm-menu-item-desc">';
									...
									if($display_readmore === 'on') :
										$html .= '<p class="pm-news-post-continue" style="margin-bottom:0px;"><a href="'. get_the_permalink() .'">'. esc_html__('Read More','viennatheme') .' &rarr;</a></p>';
									endif;
								$html .= '</div>';
							$html .= '</div>';
						$html .= '</div>';
			...
			endwhile; else:
				 $html .= '<div class="col-lg-12 pm-column-spacing">';
					$html .= '<p>'.esc_html__('No menu items were found.', 'viennatheme').'</p>';
				 $html .= '</div>';
			endif;
...
function html5Video($atts, $content = null) {
	...
	return '<div class="pm-video-container"><video id="pm-video-background" autoplay loop controls="true" muted="muted" preload="auto" volume="0"><source src="'.$mp4.'" type="video/mp4"><source src="'.$webm.'" type="video/webm"><source src="'.$ogg.'" type="video/ogg">'. _e('HTML5 Video Mime Type not found.', 'viennatheme') .'</video>'.do_shortcode($content).'</div>';
...
function sliderCarousel($atts, $content = null) { 
	...
	$html .= '<div id="vienna-carousel-'.$GLOBALS['pm_ln_carousel_count'].'" class="carousel slide" data-ride="carousel">';	
	  $html .= '<ol class="carousel-indicators">';
		$html .= '<li data-target="#vienna-carousel-'.$GLOBALS['pm_ln_carousel_count'].'" data-slide-to="0" class="active"></li>';
		$html .= '<li data-target="#vienna-carousel-'.$GLOBALS['pm_ln_carousel_count'].'" data-slide-to="1"></li>';
		$html .= '<li data-target="#vienna-carousel-'.$GLOBALS['pm_ln_carousel_count'].'" data-slide-to="2"></li>';	  
	  $html .= '</ol>';	
	  $html .= '<div class="carousel-inner">'.do_shortcode($content).'</div><a class="left carousel-control" href="#vienna-carousel-'.$GLOBALS['pm_ln_carousel_count'].'" data-slide="prev"><span class="glyphicon glyphicon-chevron-left"></span><span class="sr-only">Previous</span></a>';
	  $html .= '<a class="right carousel-control" href="#vienna-carousel-'.$GLOBALS['pm_ln_carousel_count'].'" data-slide="next">';
		$html .= '<span class="glyphicon glyphicon-chevron-right"></span>';
		$html .= '<span class="sr-only">Next</span>';
	  $html .= '</a>';
	$html .= '</div>';
	$html .= '<script>(function($) {$(document).ready(function(e) {$("#vienna-carousel-'.$GLOBALS['pm_ln_carousel_count'].'").carousel(); })(jQuery);</script>';
	...
	$html = '';
		...
		$html .= '<div class="pm-contact-form-container">';
			...
			$html .= '<form action="#" method="post" id="pm-contact-form">';
				$html .= '<input name="pm_s_full_name" id="pm_s_full_name" type="text" placeholder="'.esc_html__('Name *', 'viennatheme').'" class="pm-form-textfield">';
				$html .= '<input name="pm_s_email_address" id="pm_s_email_address" type="text" placeholder="'.esc_html__('Email *', 'viennatheme').'" class="pm-form-textfield">';
				$html .= '<input name="pm_s_subject" id="pm_s_subject" type="text" placeholder="'.esc_html__('Subject *', 'viennatheme').'" class="pm-form-textfield">';
				$html .= '<textarea name="pm_s_message" id="pm_s_message" cols="20" rows="6" placeholder="'.esc_html__('Inquiry *', 'viennatheme').'" class="pm-form-textarea"></textarea>';
