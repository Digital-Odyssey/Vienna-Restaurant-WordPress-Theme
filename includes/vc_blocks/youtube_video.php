...
vc_map( array(
    ...
    "name"      => __("YouTube Video", 'viennatheme'),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
            "type" => "textfield",
            "heading" => __("Video ID", 'viennatheme'),
            "param_name" => "el_video_id",
            "description" => __("Enter your Youtube video ID.", 'viennatheme')
        ),
		
		array(
            "type" => "textfield",
            "heading" => __("Video width", 'viennatheme'),
            "param_name" => "el_width",
            "description" => __("Enter a custom width for your video.", 'viennatheme'),
			"value"      => 300, //Add default value in $atts
        ),
		
		array(
            "type" => "textfield",
            "heading" => __("Video height", 'viennatheme'),
            "param_name" => "el_height",
            "description" => __("Enter a custom height for your video.", 'viennatheme'),
			"value"      => 250, //Add default value in $atts
        ),
		
		array(
            "type" => "dropdown",
            "heading" => __("Make video responsive?", 'viennatheme'),
            "param_name" => "el_responsive",
            "description" => __("Enable responsiveness for your video - this value overrides the Video width value.", 'viennatheme'),
