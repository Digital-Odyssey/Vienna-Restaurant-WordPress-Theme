            ...
            <div class="panel panel-default">
                <div class="panel-heading" role="tab" id="heading<?php echo $GLOBALS['pm_ln_accordion_count']; ?>">
                  <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion<?php echo $GLOBALS['pm_ln_accordion_id']; ?>" href="#<?php echo $GLOBALS['pm_ln_accordion_id'].'collapse'.$GLOBALS['pm_ln_accordion_count']; ?>" class="pm-accordion-link" aria-expanded="true" aria-controls="collapse<?php echo $GLOBALS['pm_ln_accordion_count']; ?>"><i class="<?php esc_attr_e($el_icon); ?>"></i>
...
vc_map( array(
    "name" => __("Accordion Menu", 'viennatheme'),
    ...
    "params" => array(
		...
		array(
            ...
            "param_name" => "el_id",
            "description" => __("Assign a unique number value for this Accordion Menu. If you are creating multiple Accordion Menus on a single page please make sure each accordion menu has a unique number assigned to it in order to avoid conflicts between menus.", 'viennatheme'),
...
vc_map( array(
    "name" => __("Accordion Item", 'viennatheme'),
    ...
    "params" => array(
        ...
        array(
            "type" => "textfield",
            "heading" => __("Accordion Button Text", 'viennatheme'),
            "param_name" => "el_title",
		...
		array(
            "type" => "textfield",
            "heading" => __("Accordion Button Icon", 'viennatheme'),
            "param_name" => "el_icon",
            "description" => __("Accepts a FontAwesome 4 value.", 'viennatheme'),
