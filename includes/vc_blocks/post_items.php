                        ...
                        <div class="pm-news-post-container">
                            ...
                            <div class="pm-news-post-meta-container">
                                ...
                                <ul class="pm-meta-options-list">
                                    <li><i class="fa fa-comment"></i> &nbsp;<?php echo get_comments_number().' '.esc_html__('Comments','viennatheme'); ?></li>
                                    ...
                                    <li><i class="fa fa-pencil"></i> &nbsp;<a href="<?php echo get_comments_link(); ?>"><?php esc_html_e('Post a comment','viennatheme'); ?></a></li>
                                </ul>
                            </div>
                            <div class="pm-news-post-desc-container">
                                ...
                                <p class="pm-news-post-continue"><a href="<?php the_permalink(); ?>"><?php esc_html_e('Continue Reading','viennatheme'); ?> &rarr;</a></p>
                            </div>
                        </div>
                    </div>
...
vc_map( array(
    ...
    "name"      => __("News Posts", 'viennatheme'),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
            "type" => "dropdown",
            "heading" => __("Amount of News Posts to display:", 'viennatheme'),
            "param_name" => "num_of_posts",
            "description" => __("Choose how many news posts you would like to display.", 'viennatheme'),
		...
		array(
            ...
            "param_name" => "title",
            //"description" => __("Enter a tag slug to display news posts by a specific tag.", 'viennatheme'),
		...
		array(
            ...
            "description" => __("Set the order in which news posts will be displayed.", 'viennatheme'),
