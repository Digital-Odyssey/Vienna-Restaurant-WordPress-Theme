...
vc_map( array(
    ...
    "name"      => __("Staff Profile", 'viennatheme'),
    "class"     => "",
    ...
    "params"    => array(	
		...
		array(
            "type" => "textfield",
            "heading" => __("Staff Post ID", 'viennatheme'),
            "param_name" => "id",
            "description" => __("Enter the ID number of the staff post you wish to display.", 'viennatheme'),
			"value" => ''
        ),

		array(
            "type" => "colorpicker",
            "heading" => __("Name Color", 'viennatheme'),
		...
		array(
            "type" => "colorpicker",
            "heading" => __("Title Color", 'viennatheme'),
		...
		array(
            "type" => "textfield",
            "heading" => __("Animation Delay", 'viennatheme'),
