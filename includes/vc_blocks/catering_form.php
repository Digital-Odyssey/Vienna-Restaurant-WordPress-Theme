        ...
        <form action="#" method="post" id="pm-catering-form">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <input type="submit" class="pm-rounded-submit-btn pm-clear-both" value="<?php esc_html_e('Send Request','viennatheme'); ?>" id="pm-catering-form-btn" />
...
vc_map( array(
    ...
    "name"      => __("Catering Form", 'viennatheme'),
    "class"     => "",
