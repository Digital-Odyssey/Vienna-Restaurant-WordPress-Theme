...
class pulsar_flickr extends WP_Widget {
	function pulsar_flickr() {
		...
		$widget_ops = array('classname' => 'flickr','description' => esc_html__('Flickr Widget - displays Flickr photos','viennatheme'));
		parent::__construct('flickr-photo',esc_html__('[Micro Themes] - Flickr','viennatheme'),$widget_ops);
...
function form( $instance ) {
		...
		$defaults = array( 
		'title' => esc_html__('Flickr','viennatheme'), 
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'flickrID' ); ?>"><?php esc_html_e('Flickr ID:', 'viennatheme') ?> (<a href="http://idgettr.com/">idGettr</a>)</label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'count' ); ?>"><?php esc_html_e('Number of Photos:', 'viennatheme') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'type' ); ?>"><?php esc_html_e('Type (user or group):', 'viennatheme') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'display' ); ?>"><?php esc_html_e('Display (random or latest):', 'viennatheme') ?></label>
