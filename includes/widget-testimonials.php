...
class pm_testimonials_widget extends WP_Widget {
	...
	function pm_testimonials_widget() {
		...
		parent::__construct('pm_testimonials_widget', esc_html__('[Micro Themes] - Testimonials Slider','viennatheme'), $widget_ops);
	...
	function form($instance){
		...
		?>
            ...
            <p><?php esc_html_e('Number of Testimonials to display:', 'viennatheme') ?> <input class="widefat" name="<?php echo esc_attr($this->get_field_name('numOfPosts')); ?>" type="text" value="<?php echo esc_attr($numOfPosts); ?>" /></p>
