...
class fb_likebox_widget extends WP_Widget {
	function fb_likebox_widget() {
		...
		$widget_ops = array('classname' => 'Like-box','description' => esc_html__('Facebook Like Box','viennatheme'));

		parent::__construct('Like-box',esc_html__('[Micro Themes] - Facebook Likebox','viennatheme'),$widget_ops);
...
function form( $instance ) {
		...
		$defaults = array(
			'title' => esc_html__('Facebook','viennatheme'),
			//'fa_icon' => '',
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_html_e('Title:', 'viennatheme') ?></label>
		...
		<p>  
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'minimize_header' )); ?>"><?php esc_html_e('Minimize header?', 'viennatheme'); ?></label>  
        </p>  
        ...
        <p>  
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'show_faces' )); ?>"><?php esc_html_e('Display faces?', 'viennatheme'); ?></label>  
        </p> 
        ...
        <p>  
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'show_cover' )); ?>"><?php esc_html_e('Display cover?', 'viennatheme'); ?></label>  
        </p> 
        ...
        <p>  
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'show_stream' )); ?>"><?php esc_html_e('Display stream?', 'viennatheme'); ?></label>  
        </p>  

    	<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'height' )); ?>"><?php esc_html_e('Height:', 'viennatheme') ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'page' )); ?>"><?php esc_html_e('Facebook Page URL:', 'viennatheme') ?></label>
