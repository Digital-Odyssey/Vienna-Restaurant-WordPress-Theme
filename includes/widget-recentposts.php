...
class pm_recentposts_widget extends WP_Widget {
	...
	function pm_recentposts_widget() {
		...
		$widget_ops = array(
			...
			'description' => esc_html__('Display recent posts with style.','viennatheme')
		);
		
		parent::__construct('pm_recentposts_widget', esc_html__('[Micro Themes] - Recent Posts','viennatheme'), $widget_ops);
	...
	function form($instance){
		...
		?>
            ...
            <p><?php esc_html_e('Number of Posts to display:', 'viennatheme') ?> <input class="widefat" name="<?php echo esc_attr($this->get_field_name('numOfPosts')); ?>" type="text" value="<?php echo esc_attr($numOfPosts); ?>" /></p>
