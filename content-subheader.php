    ...
    <?php if( function_exists('is_shop') ) {//Woocommerce enabled ?>
            ...
            <?php if( is_search() && is_shop() ) { ?>
                    ...
                    <div class="pm-sub-header-title-container">
                    	...
                    	<p class="pm-sub-header-title"><?php esc_html_e('Search Results for:', 'viennatheme'); ?></p>
            ...
            <?php } else if( is_shop() ) { ?>
                    ...
                    <div class="pm-sub-header-title-container">
                    	...
                    	<p class="pm-sub-header-title"><span><?php woocommerce_page_title(); ?></span></p>
            ...
            <?php } else if(  is_product_category() || is_product_tag()  ) { ?> 
            	   ...
            	   <?php $wooArchiveTitle = get_theme_mod('wooArchiveTitle', esc_html__( 'Menu items for:', 'viennatheme' )); ?>    
            ...
            <?php } else if( is_404() ) { ?>
                    ...
                    <div class="pm-sub-header-title-container">
                    	...
                    	<p class="pm-sub-header-title"><span><?php esc_html_e('404 Error', 'viennatheme'); ?></span></p>
                        <p class="pm-sub-header-message"><?php esc_html_e('Page not found', 'viennatheme'); ?></p>
            ...
            <?php } else if(is_tag()) { ?>
                    ...
                    <div class="pm-sub-header-title-container">
                    	...
                    	<p class="pm-sub-header-title"><?php esc_html_e('News tagged with:', 'viennatheme'); ?></p>
            ...
            <?php } else if(is_category()) { ?>
                    ...
                    <div class="pm-sub-header-title-container">
                    	...
                    	<p class="pm-sub-header-title"><?php esc_html_e('News filed in:', 'viennatheme'); ?></p>
            ...
            <?php } else if( is_archive() ) { ?>
                    ...
                    <div class="pm-sub-header-title-container">
                    	...
                    	<p class="pm-sub-header-title"><?php esc_html_e('Archive for', 'viennatheme'); ?></p>
