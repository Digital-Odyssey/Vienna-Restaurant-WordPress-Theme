...
<?php 
	...
	$actionBtnText = get_theme_mod('actionBtnText', esc_html__( 'Book an Event', 'viennatheme' ));	
                    ...
                    <?php if($enableActionButton == 'on') { ?>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-6 visible-lg visible-md pm-book-event">
                            <div class="pm-sub-menu-book-event">
                                <a href="<?php echo $actionBtnURL; ?>" target="<?php echo esc_attr($actionBtnTargetWindow); ?>"><?php echo esc_html__(esc_attr($actionBtnText),'viennatheme'); ?> <?php echo $actionBtnIcon !== '' ? '<i class="'.esc_attr($actionBtnIcon).'">' : '' ?> </i></a> 
                            </div>
                        </div>
