...
<div id="pm_theme_color_selector">
    ...
    <div class="pm_theme_color_selector_container">
        ...
        <select name="pm_theme_color_selector_mode" id="pm_theme_color_selector_mode">
          <option value="pm-full-mode" selected><?php esc_html_e('Fullscreen', 'viennatheme'); ?></option>
          <option value="pm-boxed-mode"><?php esc_html_e('Boxed Mode', 'viennatheme'); ?></option>
        </select>
    </div>
    <div class="pm_theme_color_selector_container">
