    ...
    <div class="row">
    	...
    	<div class="col-lg-12 col-md-12 col-sm-12 pm-search-results">
            ...
            <?php endwhile; else: ?>
            	...
            	<h5 class="pm-secondary"><?php esc_html_e('Your search entry for', 'viennatheme'); ?> "<?php echo get_search_query(); ?>" <?php esc_html_e('yielded no results.', 'viennatheme'); ?> </h5>
                
                <p><?php esc_attr__( 'Try to narrow down your search criteria by providing more generalized keywords.', 'viennatheme' ) ?></p>
                
                <?php  $searchFieldText = get_theme_mod('searchFieldText', esc_html__( 'Type Keywords...', 'viennatheme' ));  ?>
                                
                
                <br />
                <h5 class="pm-secondary"><?php esc_html_e('Try a new search:', 'viennatheme'); ?></h5>
