    ...
    <div class="pm-event-item-container">
        ...
        <div class="pm-event-item-desc">
            ...
            <?php if($pm_event_start_time_meta !== '' && $pm_event_end_time_meta !== '') : ?>
            	...
            	<p class="pm-event-item-times"><strong class="pm-primary"><?php esc_html_e('START:', 'viennatheme'); ?></strong> <?php echo esc_attr($pm_event_start_time_meta); ?> <strong class="pm-primary"><?php esc_html_e('END:', 'viennatheme'); ?></strong> <?php echo esc_attr($pm_event_end_time_meta); ?></p>
            ...
            <ul class="pm-event-item-btns">
                ...
                <?php if($pm_event_fan_page_meta !== '') { ?>
                	<li><a href="<?php echo esc_html($pm_event_fan_page_meta); ?>" class="pm-rounded-btn small event-fan-page" target="_blank"><i class="fa fa-facebook"></i> &nbsp;<?php esc_html_e('Fan Page','viennatheme'); ?></a></li>
                <?php } ?>
            </ul>
        </div>
    </div>
